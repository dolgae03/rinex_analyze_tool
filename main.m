...
for i = 1:length(files)
    ...
    dataset.constellation_name = {'GPS'	'GLO'	'GAL'	'QZS'	'BDS'	'IRN'	'SBS'};
    ...
    baseline_dataset = load('./data/obs_sam/sync_baseline.mat');
    rover_dataset = load('./data/obs_sam/sync_rover.mat');
